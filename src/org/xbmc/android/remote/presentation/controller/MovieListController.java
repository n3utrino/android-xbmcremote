...
import org.xbmc.android.remote.presentation.activity.MoviesFragment;
...
public class MovieListController extends ListController implements IController {
    ...
    public void onCreate(final Activity activity, Handler handler, ListFragment fragment) {
        ...
        if (!isCreated()) {
            ...
            super.onCreate(activity, handler, mFragment.getListView());
        ...
        mList.setOnItemClickListener(new OnItemClickListener() {
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                redirectToFragment(movie,position);
            }
        });
            ...
            mVideoManager.getMovies(new DataResponse<ArrayList<Movie>>() {
                public void run() {
                    if (value.size() > 0) {
                        ...
                        ActionBar.Tab tab = mActivity.getActionBar().getSelectedTab();
                        tab.setText("Movies (" + value.size() + ")");

                        mFragment.setListAdapter(new MovieAdapter(mActivity, value));
                    } else {
                        setTitle("Movies");
                        setNoDataMessage("No movies found.", R.drawable.icon_movie_dark);
                    }
    ...
    public void onContextItemSelected(MenuItem item) {
        int position = ((FiveLabelsItemView) ((AdapterContextMenuInfo) item.getMenuInfo()).targetView).position;
        final Movie movie = (Movie) mList.getAdapter().getItem(position);
    ...
    public void onCreateOptionsMenu(Menu menu) {
        ...
        sortMenu.getItem().setShowAsAction(MenuItem.SHOW_AS_ACTION_IF_ROOM | MenuItem.SHOW_AS_ACTION_WITH_TEXT);
